    ...
    <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="relative bg-gray-50 rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-sm hover:shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            title="Close"
          ...
          <div className="overflow-y-auto max-h-[90vh]">
            ...
            >
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <h1 id="modal-title" className="text-3xl font-bold text-gray-900 mb-2">About SwasthyaTrack</h1>
