...
import { z } from "zod";
export const roleEnum = ["PO", "Headmaster", "ClassTeacher", "MedicalTeam", "Admin", "HostelWarden", "MealSuperintendent", "Lady Superintendent"];
export const genderEnum = ["M", "F", "O"];
export const statusEnum = ["Pending", "Approved", "Rejected", "Completed"];
export const treatmentTypeEnum = ["Primary", "Referred"];
export const mealTypeEnum = ["breakfast", "lunch", "dinner"];
export const notificationTypeEnum = ["system", "manual", "health_alert", "meal_alert"];
export const flowCategoryEnum = ["none", "spotting", "light", "medium", "heavy"];
export const schoolTypeEnum = ["Government", "Aided"];
export const academicStatusEnum = ["Active", "Promoted", "Demoted", "Detained"];
export const academicActionEnum = ["Promote", "Demote", "Detain"];
export const users = pgTable("users", {
    ...
    approvalStatus: text("approval_status").notNull().$type().default("Approved"),
...
export const schools = pgTable("schools", {
    ...
    schoolType: text("school_type").notNull().$type(),
...
export const students = pgTable("students", {
    ...
    gender: text("gender").notNull().$type(),
    ...
    academicStatus: text("academic_status").notNull().$type().default("Active"),
...
export const annualHealthCards = pgTable("annual_health_cards", {
    ...
    defectsAtBirth: jsonb("defects_at_birth").$type().default([]),
    ...
    deficiencies: jsonb("deficiencies").$type().default([]),
    ...
    c7_skin_characteristics: jsonb("c7_skin_characteristics").$type().default({}),
    c7_num_lesions: text("c7_num_lesions"), // '1-5' or 'more-than-5'
    c7_lesion_type: jsonb("c7_lesion_type").$type().default({}),
    /* C7.2 Peripheral Nerve Involvement */
    c7_nerves_involved: jsonb("c7_nerves_involved").$type().default({}),
    c7_nerve_signs: jsonb("c7_nerve_signs").$type().default({}),
    /* C7.3 Contractures & Deformities */
    c7_contractures_deformities: jsonb("c7_contractures_deformities").$type().default({}),
    /* C7 Referral */
    ...
    c8_lymph_node_characteristics: jsonb("c8_lymph_node_characteristics").$type().default({}),
    /* C8.10 TB Spine */
    ...
    c9_clinical_features: jsonb("c9_clinical_features").$type().default({}),
    /* C9.2 Hemoglobin Type Classification */
    c9_hemoglobin_type: jsonb("c9_hemoglobin_type").$type().default({}),
    /* C9 Referral */
    ...
    menstrual_irregularities: jsonb("menstrual_irregularities").$type().default({}),
    menstrual_symptoms: jsonb("menstrual_symptoms").$type().default({}),
    menstrual_hygiene_practices: jsonb("menstrual_hygiene_practices").$type().default({}),
    ...
    defects_summary: jsonb("defects_summary").$type().default({}),
    deficiencies_summary: jsonb("deficiencies_summary").$type().default({}),
    diseases_summary: jsonb("diseases_summary").$type().default({}),
    referral_summary: jsonb("referral_summary").$type().default({}),
...
export const monthlyCheckups = pgTable("monthly_checkups", {
    ...
    weightKg: decimal("weight_kg", { precision: 5, scale: 2 }),
    bmi: decimal("bmi", { precision: 5, scale: 2 }),
    symptoms: jsonb("symptoms").$type().default([]),
    suggestedMedicines: jsonb("suggested_medicines").$type().default([]),
    treatmentType: text("treatment_type").$type().default("Primary"),
...
export const mealLogs = pgTable("meal_logs", {
    ...
    mealType: text("meal_type").notNull().$type(),
    menuItems: jsonb("menu_items").$type().default([]),
...
export const hostelAttendance = pgTable("hostel_attendance", {
    ...
    recordedBy: varchar("recorded_by"),
    recorderRole: text("recorder_role").$type(), // Track who recorded: HostelWarden has priority
...
export const studentAcademicActions = pgTable("student_academic_actions", {
    ...
    oldStatus: text("old_status").notNull().$type(),
    newStatus: text("new_status").notNull().$type(),
    ...
    performedByRole: text("performed_by_role").notNull().$type(),
...
export const referrals = pgTable("referrals", {
    ...
    status: text("status").notNull().$type().default("Pending"), // Pending, Approved, Rejected
...
export const notifications = pgTable("notifications", {
    ...
    senderRole: text("sender_role").notNull().$type(),
    receiverRole: text("receiver_role").notNull().$type(),
    ...
    metadata: jsonb("metadata").$type().default({}), // Additional data
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
});
export const periodTrackerEntries = pgTable("period_tracker_entries", {
    ...
    moods: jsonb("moods").$type().default([]),
    ...
    // Flow category
    flowCategory: text("flow_category").$type(),
