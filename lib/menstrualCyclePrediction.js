...
exports.identifyPeriodStarts = identifyPeriodStarts;
exports.calculateCycleStatistics = calculateCycleStatistics;
exports.predictNextCycle = predictNextCycle;
exports.predictWithDefaults = predictWithDefaults;
exports.calculateFertileWindow = calculateFertileWindow;
exports.predictMenstrualCycle = predictMenstrualCycle;
exports.quickPredict = quickPredict;
exports.isCycleRegular = isCycleRegular;
 ...
 */
function identifyPeriodStarts(entries, config = {}) {
 ...
 */
function calculateCycleStatistics(periodStarts, entries, config = {}) {
    const cfg = { ...DEFAULT_CONFIG, ...config };
 ...
 */
function predictNextCycle(statistics, config = {}) {
    const cfg = { ...DEFAULT_CONFIG, ...config };
 ...
 */
function predictWithDefaults(lastKnownPeriod, config = {}) {
    const cfg = { ...DEFAULT_CONFIG, ...config };
 ...
 */
function calculateFertileWindow(prediction, config = {}) {
    const cfg = { ...DEFAULT_CONFIG, ...config };
 ...
 */
function predictMenstrualCycle(entries, config = {}) {
    const cfg = { ...DEFAULT_CONFIG, ...config };
    const warnings = [];
 ...
 */
function getNextPeriodDate(entries, config = {}) {
 ...
 */
function getOvulationDate(entries, config = {}) {
    const result = predictMenstrualCycle(entries, config);
